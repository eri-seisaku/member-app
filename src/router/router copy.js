...
const siteRoutes = [
  {
    ...
    children: [
      ...
      {
        path: '/signup-ver1', // v-showで切り替え
        name: 'SignUpVer1',
        component: () => import('@/views/site/SignUpVer1.vue'),
        meta: { title: 'SIGNUP-VER1'}
      },
      {
        path: '/signup-ver2', // v-ifで切り替え
        name: 'SignUpVer2',
        component: () => import('@/views/site/SignUpVer2.vue'),
        meta: { title: 'SIGNUP-VER2'}
      },
      {
        path: '/signup-ver3', // フォームが1つ
        name: 'SignUpVer3',
        component: () => import('@/views/site/SignUpVer3.vue'),
        meta: { title: 'SIGNUP-VER3'}
      },
      {
        path: '/signup-ver4', // フォームが1つ
        name: 'SignUpVer4',
        component: () => import('@/views/site/SignUpVer4.vue'),
        meta: { title: 'SIGNUP-VER4'}
      },
      {
        path: '/signup', // 初期フォーム
        name: 'SignUp',
